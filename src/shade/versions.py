...
VERSIONS: dict[str, dict[str, str]] = {
    "0.1.0": {
        "cert-manager": "ghcr.io/concrete-security/shade-cert-manager:sha-339842a",
        "attestation-service": "ghcr.io/concrete-security/shade-attestation-service:sha-337f8e2",
