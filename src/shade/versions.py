...
VERSIONS: dict[str, dict[str, str]] = {
    "0.1.0": {
        "cert-manager": "ghcr.io/concrete-security/shade-cert-manager:sha-4f91add",
        "attestation-service": "ghcr.io/concrete-security/shade-attestation-service:sha-rtmr3-fix",
